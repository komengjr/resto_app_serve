                ...
                <div class="col-sm-auto">
                    <div class="row gx-2 align-items-center">
                        ...
                        <div class="col-auto pe-0"><a class="text-600 px-1"
                                ...
                                title="" data-bs-original-title="Product Grid" aria-label="Product Grid">
                                ...
                                </svg><!-- <span class="fas fa-th"></span> Font Awesome fontawesome.com --></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        ...
                                        <button class="dropdown-item" data-bs-toggle="modal"
                                            ...
                                            data-code="{{ $item->t_category_code }}"><span class="far fa-edit"></span>
                                            Edit</button>
                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#loading-modal"
                                            id="button-send-replay-massage-wa" data-code="123"><span
                                                class="far fa-folder-open"></span> Show Product</button>
