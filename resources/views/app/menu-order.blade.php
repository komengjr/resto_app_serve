                ...
                <div class="card-header bg-light">
                    <div class="row flex-between-center">
                        <div class="col-sm-auto">
                            <h5 class="mb-2 mb-sm-0">Product :</h5>
                        </div>
                        <div class="col-sm-auto"><a class="btn btn-falcon-default btn-sm" href="#!"><span
                                    class="fas fa-folder-plus me-2" data-fa-transform="shrink-2"></span>New Order</a></div>
                    </div>
                </div>
                <div class="card m-3">
                    <div class="card-body">
                            ...
                            <div class="col-4 ps-3 text-center pt-2 d-none d-sm-block">
                                <div class="rounded-1 p-2 mt-3 bg-100">
                                    <div class="text-uppercase fs--2 fw-bold">We Accept</div><img
                                        src="../../assets/img/icons/icon-payment-methods-grid.png" alt=""
                                        width="120" />
                                </div>
                            </div>
                        </div>
                        <div class="form-check d-flex align-items-center">
                            <input class="form-check-input" type="radio" value="" id="paypal"
                                name="payment-method" />
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label mb-0" for="protection-option-2"> <strong>Full
                                                ...
                                                details</label>
                                        </div><a class="fs--1 ms-3 ps-2" href="#!">Learn More<span
